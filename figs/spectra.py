...
filename1 = "../scottrun/spectra/spectra_p.txt"
filename2 = "phenixdata/phenix_proton.txt"

filepion1 = "../scottrun/spectra/spectra_pi.txt"
filepion2 = "phenixdata/phenix_pion.txt"

filekaon1 = "../scottrun/spectra/spectra_K.txt"
filekaon2 = "phenixdata/phenix_kaon.txt"
...
myproton1 = np.loadtxt(filename1,skiprows=0,unpack=True)
myproton2 = np.loadtxt(filename2,skiprows=0,unpack=True)
plt.plot(myproton1[0],myproton1[1]*0.9, 'o',label='protons')
...
plt.plot(mypion1[0],mypion1[1]*1.95, 'o',label='pions')
...
plt.plot(mykaon1[0],mykaon1[1]*1.45, 'o',label='kaons')
